...
RUN apt-get -q update \
    && wget https://releases.hashicorp.com/terraform/0.12.12/terraform_0.12.12_linux_amd64.zip -P /tmp/ \
    && wget https://releases.hashicorp.com/packer/1.4.4/packer_1.4.4_linux_amd64.zip -P /tmp/ \
    && unzip /tmp/terraform_0.12.12_linux_amd64.zip -d /usr/local/bin/ \
    && unzip /tmp/packer_1.4.4_linux_amd64.zip -d /usr/local/bin \
